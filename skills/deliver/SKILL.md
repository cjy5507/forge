...
<Purpose>
Phase 8 of the Forge pipeline. The final phase where the Tech Writer generates
...
<Use_When>
- Automatically invoked after Phase 7 (fix) completes or Phase 6 (security) passes clean
- state.json phase=8
</Use_When>
...
2. CEO compiles Delivery Report (.forge/delivery-report/report.md):
   ...
   b. Test Results Summary:
      ...
      - QA test case results (from Phase 5)
      - Security audit results (from Phase 6)
