...
| architecture.md | contracts, code_rules, plan, tasks, runtime |
| contracts/*.ts | plan, tasks, active implementation lanes |
...
|-------|---------------------|
| Design (2) | spec |
| Plan (3) | architecture, contracts, code_rules, components, tokens |
| Develop (4) | plan, architecture, contracts, code_rules, components, tokens |
| QA (5) | spec, contracts (to verify against) |
| Fix (7) | contracts, code_rules (to fix against) |
...
4. For active implementation lanes (Phase 4):
