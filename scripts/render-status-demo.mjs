...
const PHASE_LABELS = {
  ...
  develop: 'Development', qa: 'QA', security: 'Security',
...
function phaseProgress(phaseIndex, total, runtime) {
  const ranges = { 0: [0, 12], 1: [12, 25], 2: [25, 40], 3: [40, 70], 4: [70, 80], 5: [80, 90], 6: [90, 100] };
  const range = ranges[Math.min(phaseIndex, 6)] || [0, 100];
  let pct = range[0];

  // Refine within phase 3 by lane completion
  if (phaseIndex === 3 && runtime) {
