...
const REQUIRED_SECTIONS = {
  ...
  'plan.md': [/##\s+(?:\d+\.\s+)?Lanes/i, /##\s+(?:\d+\.\s+)?Execution Order/i],
};
...
const LEGACY_PHASE_MAP = new Map([
  ...
  [1, 'discovery'],
  [2, 'design'],
  // Keep numeric phase 3 mapped to develop for backward compatibility with
  // pre-plan build projects that persisted numeric phase indices.
  [3, 'develop'],
  [4, 'qa'],
  [4.5, 'security'],
  [5, 'fix'],
