...
export const DEFAULT_RUNTIME = {
  ...
  decision_trace: { ...DEFAULT_DECISION_TRACE, recent: [] },
  verification: { ...DEFAULT_VERIFICATION, edited_files: [], lane_refs: [], selected_checks: [] },
  recovery: { ...DEFAULT_RECOVERY, active: [] },
  tooling: {
    ...DEFAULT_TOOLING,
    detected_commands: { ...DEFAULT_TOOLING.detected_commands },
    edited_files: [],
    last_batch_check: { ...DEFAULT_TOOLING.last_batch_check, commands: [] },
  },
  stop_guard: {
    block_count: 0,
    last_reason: '',
